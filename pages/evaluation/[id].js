...
import { mdiEmoticonHappyOutline, mdiEmoticonNeutralOutline, 
    mdiEmoticonSadOutline, mdiCheckBold, mdiCloseThick  } from '@mdi/js';
...
const EvaluationPage = ( {meetingName, meetingDate, participations } ) => {
    ...
    function getEvaluationData() {
        ...
        for (var participation of participations) {
            ...
            // Comments
            if (participation.comment != null && checkComment(participation.comment)) {
                comments.push(
        ...
        <>  
            ...
            <e.ContentWrapper>
                ...
                <e.QuestionBox>
                    ...
                    <e.DataArea>
                        ...
                        <e.Results>
                            ...
                            <e.HorizontalText>
                                <e.Icon>
                                    <Icon path={mdiEmoticonHappyOutline} size="1.25em" color={colors.green.text} />
                                </e.Icon>
                                <e.HorizontalText>
                            ...
                            <e.HorizontalText>
                                <e.Icon>
                                    <Icon path={mdiEmoticonNeutralOutline} size="1.25em" color={colors.yellow.text} />
                                </e.Icon>
                                <e.HorizontalText>
                                    <e.ReplyTitle color={colors.yellow.text}>neutral</e.ReplyTitle>
                            ...
                            <e.HorizontalText>
                                <e.Icon>
                                    <Icon path={mdiEmoticonSadOutline} size="1.25em" color={colors.red.text} />
                                </e.Icon>
                                <e.HorizontalText>
                                    <e.ReplyTitle color={colors.red.text}>schlecht</e.ReplyTitle>
                            ...
                            <Pie
                                data={{
                                    ...
                                    datasets: [
                                    {
                                        ...
                                        backgroundColor: [colors.green.area, colors.yellow.area, colors.red.area],
                                        borderColor: [colors.green.text, colors.yellow.text, colors.red.text],
                                        borderWidth: 1
                                    },
                                    ],
                                }}
                                height={65}
                                options={{ maintainAspectRatio: false, legend: false, tooltips: false }}
                            />
                        </e.PieChart>
                ...
                <e.QuestionBox>
                    ...
                    <e.DataArea>
                        ...
                        <e.Results>
                            ...
                            <e.HorizontalText>
                                <e.Icon>
                                    <Icon path={mdiCheckBold} size="1.25em" color={colors.green.text} />
                                </e.Icon>
                                <e.HorizontalText>
                            ...
                            <e.HorizontalText>
                                <e.Icon>
                                    <Icon path={mdiCloseThick} size="1.25em" color={colors.red.text} />
                                </e.Icon>
                                <e.HorizontalText>
                ...
                <e.QuestionBox>
                    ...
                    <e.QuestionTitle>Wie gut war das Meeting vorbereitet?</e.QuestionTitle>
                    ...
                    <e.DataArea>
                        ...
                        <e.Results>
                            ...
                            <e.HorizontalText>
                                <e.ReplyTitle color={colors.green.text}>sehr gut</e.ReplyTitle>
                                <e.ReplyVotes>{preparation.verygood} Votes</e.ReplyVotes>
                            </e.HorizontalText>

                            <e.HorizontalText>
                                <e.ReplyTitle color={colors.lightgreen.text}>gut</e.ReplyTitle>
                                <e.ReplyVotes>{preparation.good} Votes</e.ReplyVotes>
                            </e.HorizontalText>

                            <e.HorizontalText>
                                <e.ReplyTitle color={colors.orange.text}>schlecht</e.ReplyTitle>
                                <e.ReplyVotes>{preparation.bad} Votes</e.ReplyVotes>
                            </e.HorizontalText>

                            <e.HorizontalText>
                                <e.ReplyTitle color={colors.red.text}>sehr schlecht</e.ReplyTitle>
                        ...
                        <e.PieChart>
                            <Pie
                                data={{
                                    ...
                                    datasets: [
                                    {
                                        data: [preparation.verygood, preparation.good, preparation.bad, preparation.verybad],
                                        backgroundColor: [colors.green.area, colors.lightgreen.area, colors.orange.area, colors.red.area],
                                        borderColor: [colors.green.text, colors.lightgreen.text, colors.orange.text, colors.red.text],
                                        borderWidth: 1
                                    },
                                    ],
                                }}
